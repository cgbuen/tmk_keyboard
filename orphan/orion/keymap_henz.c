...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = KEYMAP_WINKEYLESS(\
        ...
        LCTL, A,   O,   E,   U,   I,   D,   H,   T,   N,   S,  MINS,     ENT,                       \
        TRNS, TRNS,SCLN,   Q,   J,   K,   X,   B,   M,   W,V, Z, RSFT,          TRNS,   UP,        \
        LCTL,LGUI,LALT,               TRNS,                     RALT,RGUI,RCTL,      LEFT,DOWN,RGHT),
    ...
    [4] = KEYMAP_WINKEYLESS(\
        BTLD, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,       PSCR,SLCK,BRK,  \
        GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   SLSH,EQL, GRV,BSPC,      INS, HOME,PGUP, \
        TAB, FN9,FN10,MS_U, P,   Y,   F,   G,   C,   R,   L,   LBRC,RBRC,BSLS,      DEL, END, PGDN, \
        LCTL, A,   MS_L,   MS_D,   MS_R,   I,   D,   H,   T,   N,   BTN1,BTN3,BTN2,                       \
        TRNS, TRNS,SCLN,   Q,   J,   K,   X,   B,   M,   W,V, Z,     RSFT, TRNS ,         VOLU,        \
        LCTL,LGUI,LALT,               TRNS,                     RALT,RGUI,RCTL,      MUTE,VOLD,RGHT),
